            ...
            >
              {[
                ...
                <motion.a 
                  key={index}
                  href={social.href} 
                  className="group flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gray-800 hover:bg-gold rounded-lg transition-all duration-300 transform hover:scale-110"
