        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              <a href="#" className="group flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gray-800 hover:bg-red-600 rounded-lg transition-all duration-300 transform hover:scale-110">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="group flex items-start p-3 bg-gray-800/30 hover:bg-gray-800/50 rounded-lg transition-all duration-300 border border-gray-700/30 hover:border-red-500/30">
                <div className="flex items-center justify-center w-10 h-10 bg-red-600 rounded-lg mr-4 group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div>
                  ...
                  <a href="tel:7605188451" className="text-red-400 hover:text-red-300 transition-colors font-medium">(760) 518-8451</a>
                </div>
              </div>
              ...
              <div className="group flex items-start p-3 bg-gray-800/30 hover:bg-gray-800/50 rounded-lg transition-all duration-300 border border-gray-700/30 hover:border-red-500/30">
                ...
                <div>
                  ...
                  <a href="mailto:SDclassicautodetail@outlook.com" className="text-red-400 hover:text-red-300 transition-colors break-all">SDclassicautodetail@outlook.com</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700/50 mt-12 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="text-gray-400 text-sm">
              © 2024 San Diego Classic Car Detail. All rights reserved.
            </div>
