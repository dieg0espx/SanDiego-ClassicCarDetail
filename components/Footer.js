        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 lg:gap-4">
              <a href="#" className="group flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gray-800 hover:bg-gold rounded-lg transition-all duration-300 transform hover:scale-110">
                <svg className="w-4 h-4 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700/50 mt-8 sm:mt-12 pt-6 sm:pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-3 lg:space-y-0">
            ...
            <div className="flex flex-wrap justify-center lg:justify-end gap-4 sm:gap-6">
              <Link href="#" className="text-gray-400 hover:text-white transition-colors duration-200 hover:underline text-xs sm:text-sm">Privacy Policy</Link>
              <Link href="#" className="text-gray-400 hover:text-white transition-colors duration-200 hover:underline text-xs sm:text-sm">Terms of Service</Link>
              <Link href="#" className="text-gray-400 hover:text-white transition-colors duration-200 hover:underline text-xs sm:text-sm">Sitemap</Link>
            </div>
          </div>
        </div>
      </div>
