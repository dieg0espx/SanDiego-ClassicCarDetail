        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 relative">
            <div className="text-center">
              ...
              <div className="text-3xl sm:text-4xl font-bold text-red-600 mb-4">$125</div>
              <p className="text-gray-600 mb-6 text-sm sm:text-base">Perfect for a quick, refreshing clean.</p>
            </div>
            
            <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
              <li className="flex items-start">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mt-0.5 mr-2 sm:mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="text-center">
              <a href="tel:(760) 518-8451" className="bg-red-600 hover:bg-red-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold transition-colors inline-block text-sm sm:text-base w-full sm:w-auto">
                Book Now
              </a>
            </div>
          </div>
          ...
          {/* The Sunset Shine */}
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 relative border-2 border-red-600 md:col-span-2 lg:col-span-1">
            ...
            <div className="text-center">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">The Sunset Shine</h3>
              <div className="text-3xl sm:text-4xl font-bold text-red-600 mb-4">$180</div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 relative md:col-span-2 lg:col-span-1">
            <div className="text-center">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">The Hot Rod Detail</h3>
              <div className="text-3xl sm:text-4xl font-bold text-red-600 mb-4">$250</div>
