    ...
    <section id="contact" className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-stretch">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center group">
                <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-red-100 rounded-xl flex items-center justify-center group-hover:bg-red-200 transition-colors">
                ...
                <div className="ml-3 sm:ml-4">
                  ...
                  <a href="tel:(760) 518-8451" className="text-base sm:text-lg font-semibold text-gray-900 hover:text-red-600 transition-colors">
                    (760) 518-8451
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center group">
                ...
                <div className="ml-3 sm:ml-4">
                  ...
                  <a href="mailto:SDclassicautodetail@outlook.com" className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 hover:text-red-600 transition-colors break-all">
          ...
          {/* Main Call to Action */}
          <div className="bg-gradient-to-br from-red-600 to-red-700 rounded-2xl shadow-xl p-6 sm:p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div className="space-y-3 sm:space-y-4">
                <a
                  ...
                  className="w-full bg-white text-red-600 hover:bg-gray-100 font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl text-base sm:text-lg transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                ...
                <a
                  ...
                  className="w-full bg-transparent border-2 border-white text-white hover:bg-white hover:text-red-600 font-semibold py-3 sm:py-4 px-4 sm:px-6 rounded-xl text-base sm:text-lg transition-all duration-300 flex items-center justify-center"
                >
