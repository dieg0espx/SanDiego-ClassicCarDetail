      ...
      <section className="bg-red-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-6 text-3xl font-bold text-white">$180</div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Enhanced Exterior</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-gray-900">Everything in Classic Wash</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-gray-900">Door Jambs Cleaning</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-gray-900">Spray Wax Protection</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-gray-900">Plastic Dressing</span>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Premium Interior</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-red-600 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    <span className="font-semibold text-gray-900">In-Depth Interior Vacuum</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-gray-900">UV Protectant Treatment</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-gray-900">Leather Protection</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-gray-900">Enhanced Window Cleaning</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Enhanced Shine</h3>
              <p className="text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Special Occasions</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Value Seekers</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">San Diego Living</h3>
