          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-black">Exterior Cleaning</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Two-Stage Hand Wash</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Wheel & Tire Cleaning</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Safe Drying</span>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-black">Interior Cleaning</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-gold mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    <span className="font-semibold text-black">Light Interior Vacuum</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Dashboard & Console Wipe Down</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Window Cleaning</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-black mb-2">Step 1: Prewash</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-black mb-2">Step 2: Contact Wash</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-black mb-2">Step 3: Final Touches</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-black mb-2">Quick Refresh</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-black mb-2">Budget-Friendly</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-black mb-2">Mobile Service</h3>
