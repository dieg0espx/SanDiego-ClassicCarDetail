          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">The Classic Wash</h3>
                <div className="text-2xl sm:text-3xl font-bold text-red-600 mb-3 sm:mb-4">$125</div>
                ...
                <ul className="space-y-2 mb-4 sm:mb-6">
                  <li className="flex items-center text-xs sm:text-sm text-gray-700">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4 text-red-600 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                  <Link href="/services/classic-wash" className="flex-1 bg-red-600 hover:bg-red-700 text-white text-center py-2 sm:py-2 px-4 rounded-lg font-semibold transition-colors text-sm sm:text-base">
                    Learn More
                  </Link>
            ...
            {/* The Sunset Shine */}
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow border-2 border-red-600">
              ...
              <div className="p-6">
                ...
                <div className="text-3xl font-bold text-red-600 mb-4">$180</div>
                ...
                <div className="flex space-x-3">
                  <Link href="/services/sunset-shine" className="flex-1 bg-red-600 hover:bg-red-700 text-white text-center py-2 px-4 rounded-lg font-semibold transition-colors">
                    Learn More
                  </Link>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="text-3xl font-bold text-red-600 mb-4">$250</div>
                ...
                <div className="flex space-x-3">
                  <Link href="/services/hot-rod-detail" className="flex-1 bg-red-600 hover:bg-red-700 text-white text-center py-2 px-4 rounded-lg font-semibold transition-colors">
                    Learn More
                  </Link>
                  <a href="tel:(760) 518-8451" className="flex-1 bg-gray-600 hover:bg-gray-700 text-white text-center py-2 px-4 rounded-lg font-semibold transition-colors">
                    Book Now
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-3">
                  <a href="tel:(760) 518-8451" className="flex-1 bg-red-600 hover:bg-red-700 text-white text-center py-2 px-4 rounded-lg font-semibold transition-colors text-sm">
                    Book Now
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Ceramic Coating</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Interior Detailing</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Engine Bay Cleaning</h3>
      ...
      <section className="py-20 bg-red-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-red-100 mb-8">
            Book your service today and see why San Diego Classic Car Detail is the trusted choice for vehicle care.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/contact" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-red-600 font-bold px-8 py-3 rounded-lg transition-colors">
              Request Quote
            </a>
          </div>
        </div>
