          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-black">Premium Exterior</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Everything in Sunset Shine</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Three-Step Wash & Wax</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Detailed Wheel & Tire Cleaning</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Premium Tire Dressing</span>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-black">Show-Quality Interior</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-gold mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    <span className="font-semibold text-black">Full Interior Shampoo</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Leather Reconditioning</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">In-Depth Vacuum & Cleaning</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-semibold text-black">Premium Interior Protection</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-black mb-2">Step 1: Prewash</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-black mb-2">Step 2: Contact Wash</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-black mb-2">Step 3: Hydro Foam</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-black mb-2">Step 4: Interior Detail</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-black mb-2">Car Shows</h3>
