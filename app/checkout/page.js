      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Auth loading: {loading ? 'true' : 'false'}, App loading: {isLoading ? 'true' : 'false'}
          </p>
        </div>
      </div>
    )
            ...
            {steps.map((step, stepIdx) => (
              <div key={step.id} className="flex items-center">
                <div className={`flex items-center justify-center w-8 h-8 rounded-full ${
                  currentStep >= step.id ? 'bg-gold text-white' : 'bg-gray-200 text-gray-500'
                }`}>
                  {step.id}
                </div>
                <div className="ml-2">
            ...
            {currentStep === 3 && (
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="bg-gold/10 border border-gold/20 rounded-lg p-4 mb-6">
                  <h3 className="text-lg font-semibold text-gold mb-3">Scheduled Appointment</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-8">
              ...
              <div className="border-t border-gray-200 pt-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-gold">{formatPrice(total + (location?.serviceAreaCost || 0))}</span>
                </div>
              </div>
